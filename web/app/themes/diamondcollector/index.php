                        ...
                        <div class="row">
                            <div class="col-6 col-lg-3">
                                ...
                                <img class="animate" id="PurpleDiamond"
                                    src="https://salty-wildwood-84039.herokuapp.com/wp/wp-content/uploads/2020/08/purple.png"
                                    alt="purple diamond">
                            </div>
                            ...
                            <div class="col-6 col-lg-3">
                                <img id="redDiamond" class="hidden"
                                    ...
                                    src="https://salty-wildwood-84039.herokuapp.com/wp/wp-content/uploads/2020/08/red.png"
                                    alt="red diamond">
                            </div>
                            <div class="col-6 col-lg-3">
                                <img id="blueDiamond" class="hidden"
                                    ...
                                    src="https://salty-wildwood-84039.herokuapp.com/wp/wp-content/uploads/2020/08/blue.png"
                                    alt="blue diamond">
                            </div>
                            <div class="col-6 col-lg-3">
                                <img id="greenDiamond" class="hidden"
                                    ...
                                    id="GreenDiamond"
                                    src="https://salty-wildwood-84039.herokuapp.com/wp/wp-content/uploads/2020/08/green.png"
                                    alt="green diamond">
